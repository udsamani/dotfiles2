...
local on_attach = function(client, bufnr)
  ...
  nnoremap('<leader>h', vim.lsp.buf.hover, bufopts, "Hover")
 ...
 nnnoremap('<space>rn', vim.lsp.buf.rename, bufopts, "Rename")
  ...
  vim.keymap.set('v', "<space>em", [[<ESC><CMD>lua require('jdtls').extract_method(true)<CR>]],
    { noremap=true, silent=true, buffer=bufnr, desc = "Extract method" })s()
end
...
local config = {
  ...
  cmd = {
    ...
    '-jar', vim.fn.glob('/opt/homebrew/Cellar/jdtls/1.23.0/libexec/plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar'),
